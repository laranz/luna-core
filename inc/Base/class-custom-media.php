<?php
/**
 * A wrapper class for Custom Media Widget Manager.
 *
 * @package         Luna_Core
 * @author          laranz
 ...
 * @author          laranz
 */
class Custom_Media_Widget extends Base_Controller {
	...
	public function register() {
		...
		if ( $this->deactivated( 'media_widget_manager' ) ) {
			return;
		}
	...
	public function set_subpages() {
		$this->subpages = array(
			array(
				...
				'page_title'  => __( 'Media Settings', 'luna-core' ),
				'menu_title'  => __( 'Media Settings', 'luna-core' ),
				'capability'  => 'manage_options',
				'menu_slug'   => 'luna_media_widget',
				'callback'    => array( $this->callbacks, 'add_media_widget_cb' ),
				'position'    => 3,
			),
		);
	}
